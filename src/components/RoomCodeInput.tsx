    ...
    <form onSubmit={handleSubmit} className="flex items-center justify-center gap-3 w-full">
      <div className="relative">
        ...
        <input
          ...
          maxLength={4}
          className="w-52 sm:w-64 pl-12 pr-4 py-4 rounded-2xl bg-white/15 border border-white/30 text-white text-lg font-mono tracking-[0.35em] placeholder:text-gray-400 placeholder:tracking-[0.2em] focus:outline-none focus:border-primary-400/80 focus:ring-2 focus:ring-primary-500/35 transition-all shadow-lg shadow-black/20"
        />
      </div>
      <button
        type="submit"
