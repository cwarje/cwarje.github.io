...
export const GAME_REGISTRY: Record<GameType, GameDefinition> = {
  yahtzee: {
    ...
    icon: Dice5,
    theme: {
      gradient: 'from-amber-500/35 to-orange-600/35',
  ...
  farkle: {
    ...
    icon: Dice5,
    theme: {
      gradient: 'from-violet-500/35 to-purple-600/35',
  ...
  hearts: {
    ...
    icon: Heart,
    theme: {
      gradient: 'from-rose-500/35 to-pink-600/35',
  ...
  poker: {
    ...
    icon: Club,
    theme: {
      gradient: 'from-slate-400/35 to-slate-600/35',
  ...
  'up-and-down-the-river': {
    ...
    icon: ArrowUpDown,
    theme: {
      gradient: 'from-teal-500/35 to-sky-600/35',
  ...
  mobilization: {
    ...
    icon: PigIcon,
    theme: {
      gradient: 'from-pink-500/35 to-pink-600/35',
  ...
  twelve: {
    ...
    icon: Crown,
    theme: {
      gradient: 'from-blue-500/35 to-indigo-600/35',
  ...
  settler: {
    ...
    icon: Hexagon,
    theme: {
      gradient: 'from-amber-500/35 to-yellow-600/35',
      cardBorder: 'border-amber-500/30',
      hoverBorder: 'hover:border-amber-500/40',
      playersTag: 'bg-amber-500/25 text-amber-200 border border-amber-500/30',
  ...
  'cross-crib': {
    ...
    icon: LayoutGrid,
    theme: {
      gradient: 'from-emerald-500/35 to-teal-600/35',
  ...
  cribbage: {
    ...
    theme: {
      gradient: 'from-cyan-500/35 to-blue-600/35',
  ...
  casino: {
    ...
    icon: Layers,
    theme: {
      gradient: 'from-lime-500/35 to-green-600/35',
  ...
  pong: {
    ...
    icon: Circle,
    theme: {
      gradient: 'from-zinc-400/35 to-zinc-600/35',
  ...
  cucumber: {
    ...
    icon: CucumberIcon,
    theme: {
      gradient: 'from-green-500/35 to-emerald-600/35',
