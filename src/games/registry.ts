...
export const GAME_REGISTRY: Record<GameType, GameDefinition> = {
  yahtzee: {
    ...
    icon: Dice5,
    theme: {
      gradient: 'from-amber-500/45 to-orange-600/45',
  ...
  farkle: {
    ...
    icon: Dice5,
    theme: {
      gradient: 'from-violet-500/45 to-purple-600/45',
  ...
  hearts: {
    ...
    icon: Heart,
    theme: {
      gradient: 'from-rose-500/45 to-pink-600/45',
  ...
  poker: {
    ...
    icon: Club,
    theme: {
      gradient: 'from-red-500/45 to-red-700/45',
      cardBorder: 'border-red-500/40',
      hoverBorder: 'hover:border-red-500/50',
      playersTag: 'bg-red-500/25 text-red-200 border border-red-500/30',
      iconColor: 'text-red-400',
      buttonColors: 'bg-red-600 hover:bg-red-500',
      panelBg: 'bg-red-950',
  ...
  'up-and-down-the-river': {
    ...
    info: {
      ...
      rules: [
        ...
        'When "Allow perfect bids" is off, the dealer cannot bid so that total bids equal tricks available.',
      ...
      howToPlay: [
        'When the host starts the game, pick either Up and Down (1-7-1) or Down and Up (7-1-7), and choose whether perfect bids are allowed.',
    ...
    icon: ArrowUpDown,
    theme: {
      gradient: 'from-teal-500/45 to-sky-600/45',
  ...
  mobilization: {
    ...
    icon: PigIcon,
    theme: {
      gradient: 'from-pink-500/45 to-pink-600/45',
  ...
  twelve: {
    ...
    info: {
      ...
      rules: [
        ...
        'At round start, choose 0–6 table piles per player (0 deals the full deck to hand). With piles, each pile is one face-down card with one face-up card on top; remaining cards go to hand.',
        'On your turn, play either a hand card or, if you have piles, the exposed top card from one of your table piles.',
        ...
        'With 4 players, opposite seats form fixed teams. Teams share their score toward 12, and captured card points are combined at the end of each round. After winning a trick, you may ask your teammate to set trump if they have a royal pair (K+Q same suit).',
        'Tjog is pronounced like "chog" (soft \'tj\' sound).',
      ],
      howToPlay: [
        'Choose the pile count at launch (0 for hand-only), then review your hand and any table piles.',
        'If it is your turn and you have a royal pair (K+Q same suit), you may set trump (+2) unless your score is 10 or more. In 4-player teams you can also ask your partner to set trump for the same +2 (partner must have the royal pair and score under 10).',
    ...
    icon: Crown,
    theme: {
      gradient: 'from-blue-500/45 to-indigo-600/45',
  ...
  settler: {
    ...
    icon: Hexagon,
    theme: {
      gradient: 'from-amber-500/45 to-yellow-600/45',
      cardBorder: 'border-amber-500/40',
      hoverBorder: 'hover:border-amber-500/50',
      playersTag: 'bg-amber-500/25 text-amber-200 border border-amber-500/30',
  ...
  'cross-crib': {
    ...
    icon: LayoutGrid,
    theme: {
      gradient: 'from-emerald-500/45 to-teal-600/45',
  ...
  cribbage: {
    ...
    theme: {
      gradient: 'from-cyan-500/45 to-blue-600/45',
  ...
  casino: {
    ...
    icon: Layers,
    theme: {
      gradient: 'from-lime-500/45 to-green-600/45',
  ...
  cucumber: {
    ...
    icon: CucumberIcon,
    theme: {
      gradient: 'from-green-500/45 to-emerald-600/45',
  ...
  golf: {
    ...
    info: {
      ...
      howToPlay: [
        'At the start of each hole, tap two face-down table cards when it is your turn.',
        ...
        'After discarding a stock draw, tap a face-down card to flip it, or tap Skip beside the HUD text.',
