...
export type TwelvePileCount = 0 | 3 | 4 | 5 | 6;
...
export type ClientMessage =
  | { type: 'join'; playerName: string; playerColor: PlayerColor; deviceId: string; xp?: number; selectedHat?: HatId }
  | { type: 'update-profile'; playerName: string; playerColor: PlayerColor; deviceId: string; xp?: number; selectedHat?: HatId }
